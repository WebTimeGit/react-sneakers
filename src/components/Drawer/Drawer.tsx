		...
		<div className={ styles.drawer_overlay }>
			<div className={ styles.drawer }>
				<div className={ styles.drawer_top }>
					<h2>
						Корзина
						<span className='item_remove' onClick={ onClickCloseCart }>
                            <span></span>
                            <span></span>
                        </span>
					</h2>
				...
				{ items.length > 0 ?
						...
						<div className={ styles.drawer_body }>
							{
								items.map((obj: ICard, i: number) => (
									<div className={ styles.cart_item } key={ i }>
										...
										<div className='item_remove' onClick={ () => onRemoveCartItem(obj.id) }>
											<span></span>
											<span></span>
										</div>
									</div>
					...
					: <EmptyCart onClickCloseCart={ onClickCloseCart }/>
				}
